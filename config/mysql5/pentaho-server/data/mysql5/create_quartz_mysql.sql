...
grant all on quartz.* to 'pentaho_user'@'localhost' identified by '@@pentaho_user_password@@';
grant all on quartz.* to 'pentaho_user'@'%' identified by '@@pentaho_user_password@@';
